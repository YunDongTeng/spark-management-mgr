...
(function() {
	...
	var $WeAudiobUpload = function(pictureId) {
	...
	$WeAudiobUpload.prototype = {
		...
		bindEvent : function(bindedObj) {
			...
			bindedObj.on('uploadSuccess', function(file,response) {
                var $li = $('<div><audio controls="controls"><source src="" >不支持音频播放</audio></div>');
                var $audio = $li.find('source');
	...
	window.$WeAudiobUpload = $WeAudiobUpload;
}());