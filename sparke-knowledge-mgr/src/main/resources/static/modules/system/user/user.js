...
MgrUser.initColumn = function () {
    var columns = [
        ...
        {title: '状态', field: 'status', align: 'center', valign: 'middle', sortable: true,formatter : function (e,column,index) {
            var html = '';
            switch (e){
                case 1:
                    html += '<span class="label label-success">启用中</span>';
                    break;
                case 2:
                    html += '<span class="label label-default">已冻结</span>';
                    break;
                default:break;
            }
            return html;
