 ...
 */
public abstract class SparkTemplateEngine extends AbstractTemplateEngine {
    ...
    public void configTemplate(Template template) {
        ...
        template.binding("mapping", super.getMappingConfig());
    }
    ...
    public void start() {
        ...
        if (super.contextConfig.getEntitySwitch() && super.contextConfig.getHasProperties()) {
            generateEntity();
        }
        if (super.contextConfig.getMapperSwitch() && super.contextConfig.getHasProperties()) {
            generateMapping();
        }
    }
